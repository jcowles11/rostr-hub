    ...
    <>
      <TopBar
        ...
        actions={[
          ...
          { kind: "ghost", label: "Duplicate" },
          { kind: "ghost", label: "Templates" },
          { kind: "primary", label: "Publish to team" },
        ]}
      />
      ...
      <div className="bg-card border border-hair rounded-lg">
        <div className="p-5 border-b border-hair-2 flex items-start gap-3">
          ...
          <div className="flex gap-1.5">
            ...
            <Button variant="red" size="sm">Save plan</Button>
          </div>
        </div>
      ...
      <div className="p-4">
        <div className="bg-ink text-white rounded-md p-4">
          ...
          <div className="mt-4 flex gap-1.5">
            <button className="flex-1 py-2.5 bg-white/10 hover:bg-white/20 rounded-sm text-[11.5px] font-bold">
              + Note
            </button>
            <button className="flex-[2] py-2.5 bg-red hover:bg-red/90 rounded-sm text-[11.5px] font-bold inline-flex items-center justify-center gap-1.5">
