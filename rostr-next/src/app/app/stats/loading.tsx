    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-6 lg:px-8 pt-6 pb-12">
        <div className="max-w-layout-hub mx-auto">
          <div className="h-8 bg-muted/40 rounded w-40 mb-4 animate-pulse" />
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
            {[0, 1, 2, 3].map((i) => (
              <div key={i} className="h-20 bg-card border border-hair rounded-lg animate-pulse" />
            ))}
          </div>
          <div className="mt-7 h-72 bg-card border border-hair rounded-lg animate-pulse" />
        </div>
      </div>
    </div>
  );
