...
export default function PlayerSearchFilters({ onSearch, loading }: Props) {
      ...
      <CardContent className="space-y-4">
          ...
          <div className="space-y-2 rounded-lg border border-dashed p-2.5">
            ...
            <div className="flex gap-2">
              <Input
                ...
                placeholder="Min"
                value={newMetricMin}
                onChange={(e) => setNewMetricMin(e.target.value)}
                className="h-8 text-xs rounded-lg"
              />
              <Input
                type="number"
        ...
        <div className="flex gap-2 pt-2">
          <Button
            ...
            disabled={loading}
            className="flex-1 gradient-primary border-0 text-primary-foreground font-bold rounded-xl"
          >
